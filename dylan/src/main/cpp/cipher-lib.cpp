...
jstring
Java_dom_team_ciphergo_CipherCore_getString(JNIEnv *env, jobject instance, jstring key_) {
...
void Java_dom_team_ciphergo_CipherCore_init(JNIEnv *env, jclass type) {
    LOAD_MAP(_map);
}
